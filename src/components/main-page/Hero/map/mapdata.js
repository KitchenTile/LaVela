var simplemaps_worldmap_mapdata = {
  ...
  regions: {
    0: {
      ...
      zoomable: "no",
      description: "0 artists from North America",
    },
    1: {
      name: "South America",
      states: [
      ...
      zoomable: "no",
      description: "0 artists from South America",
    },
    2: {
      name: "Europe",
      states: [
      ...
      zoomable: "no",
      description: "0 artists from Europe",
    },
    3: {
      ...
      zoomable: "no",
      description: "0 artists from Africa & ME",
    },
    4: {
      name: "South Asia",
      states: [
      ...
      zoomable: "no",
      description: "0 artists from South Asia",
    },
    5: {
      name: "North Asia",
      states: ["MN", "RU", "KZ"],
      description: "0 artists from North Asia",
      zoomable: "no",
    },
  },
